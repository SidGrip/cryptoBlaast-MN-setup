...
COIN_TGZ='https://github.com/SidGrip/cryptoBlast-MN-setup/raw/master/blast.tar.gz'
...
bsdmainutils libdb4.8++-dev libminiupnpc-dev libgmp3-dev ufw pkg-config libevent-dev libdb5.3++ unzip libzmq5 libboost-all-dev"
 exit 1
fi
clear
}
